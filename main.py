...
def attack(char_name: str, char_class: str) -> str:
    """Вычисление урона и вывод на экран."""
    dmg: int = 5
...
def defence(char_name: str, char_class: str) -> str:
    """Вычисление блокированного урона и вывод на экран."""
    block: int = 10
    if char_class == 'warrior':
        block += randint(5, 10)
    elif char_class == 'mage':
...
def special(char_name: str, char_class: str) -> str:
    """Вычисление специальной способности и вывод на экран."""
    msg: str = f'{char_name} применил специальное умение '
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Начало использования возможностей персонажа."""
    if char_class == 'warrior':
